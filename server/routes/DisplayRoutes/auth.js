...
import { loginSuccess, loginFailed, googleLogin, googleCallback, logout, googleLogine } from "../../controllers/PanelControllers/googleAuth.js";
...
router.post("/auth/google/verify", googleLogine);
